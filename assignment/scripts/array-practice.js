...
let favoriteFoods = ['KC BBQ'];

// 1.b. TODO: Log your array of foods to the console with a message, similar 
//      to the example above

console.log('KC BBQ: ', favoriteFoods);
...
favoriteFoods.unshift('Ribs')
console.log('Added ribs to the beginning: ${favoriteFoods}');
...
removedFoods = favoriteFoods.shift('ribs');
